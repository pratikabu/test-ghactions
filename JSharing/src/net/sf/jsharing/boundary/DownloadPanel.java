...
public class DownloadPanel extends RequestPanel implements Runnable, NetworkActivity {
	...
	private void initComponents() {
		...
		jTextField2
				.setToolTipText("Folder location where all the downloads will be saved.");
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		if (jButton1.getText().equals("Close")) {
			NewRequestDialog.getNewRequestDialog().removePopupPanel(
					this.getPopupPanel());
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
		...
		tDownload = new UninterruptibleThread(this, "Sending List to: "
	...
	private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton7ActionPerformed
		...
		if (SavedIPInfoDialog
				.showSavedIPInfoDialog(DownloadDialog.getDD(), sip)) {
			loadIPInfo();
		...
		if (Desktop.isDesktopSupported()) {
			try {
				Desktop.getDesktop().open(
						new File(UsefulMethods.getLastSavedLocation()));
			} catch (IOException e) {
				JOptionPane.showMessageDialog(
						this,
						"Following error occurred while opening:\n"
								+ e.getMessage(), "Cannot Open",
						JOptionPane.ERROR_MESSAGE);
			}
		} else {
			JOptionPane.showMessageDialog(this,
					"Your system does not support this operation.",
					"Cannot Open", JOptionPane.ERROR_MESSAGE);
		}
	...
	private void downloadFiles() {
		...
		client = new Client(sendToServer.getServerAddress(),
				sendToServer.getPortNumber(), this);
		...
		try {
			...
			JOptionPane.showMessageDialog(this, msg + "\n"
					+ "The system replied with: " + e.getLocalizedMessage(),
					"Error while Downloading", JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	private void saveAndLoadSaveLocation(File file) {
		// save to properties
		UsefulMethods.props.setProperty(UsefulMethods.P_LAST_SAVE_LOCATION,

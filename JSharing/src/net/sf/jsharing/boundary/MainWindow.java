...
public class MainWindow extends javax.swing.JFrame implements NetworkActivity {
    ...
    private void initComponents() {
        ...
        jMenuItem15.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.SHIFT_MASK | java.awt.event.InputEvent.CTRL_MASK));
        ...
        jMenuItem10.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_J, java.awt.event.InputEvent.SHIFT_MASK | java.awt.event.InputEvent.CTRL_MASK));
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        ...
        if(serverName != null) {
            if(!serverName.contains(",")) {
                ...
                JOptionPane.showMessageDialog(this, "The computer name cannot contains \",\".\n"
    ...
    private void exitProgram() {
        boolean exit = true;
        if(!ThreadManager.ensureThreadsCompleted(new int[]{ThreadManager.UNINTERRUPTIBLE_THREAD})){
            exit = false;
            //show running threads
            exit = ExitThreadsMonitorWindow.showRunningThreads(this, new int[]{ThreadManager.UNINTERRUPTIBLE_THREAD});
        }

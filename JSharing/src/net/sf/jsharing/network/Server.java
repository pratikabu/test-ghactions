...
public class Server {
	...
	public static final int RUNNING = 1, STOPPED = 2, EXCEPTION_START = 3,
			EXCEPTION_STOP = 4;
	...
	/**
	 * This method will shutdown the server. Which includes the removing of the
	 * ServerSocket from the port number.
	 * 

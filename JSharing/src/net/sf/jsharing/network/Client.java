...
public class Client {
	 ...
	 */
	public Client(String serverAddress, int portNumber, NetworkActivity ca)
			throws UnknownHostException {
	...
	private void downloadTransferrableObject(TransferrableObject to)
		...
		for (FileInfo fi : to.getFiles()) {
			...
			TransferrableObject singleTO = new TransferrableObject(
					to.getTaskType());
			...
			FileOutputStream fos = new FileOutputStream(new File(
					saveToDirectory, fi.getFileName()));

...
public class UploadFormPanel extends javax.swing.JPanel implements Runnable {
	...
	private void initComponents() {
		...
		jPanel1.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Upload Files:"));
	...
	private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
		...
		t = new UninterruptibleThread(this, "Sending List to: "
				+ jTextField1.getText() + ", " + jSpinner1.getValue());
		t.start();
	...
	public void run() {
		...
		if (to.getFiles().isEmpty()) {
			JOptionPane.showMessageDialog(UploadDialog.getUD(),
		...
		try {
			client = new Client(jTextField1.getText(),
					(Integer) jSpinner1.getValue(), null);
			...
			UsefulMethods.log.log(Level.ERROR,
					"Unkown host exception is thrown.", e);
		}
		...
		if (client != null) {
			try {
				...
				JOptionPane.showMessageDialog(
						this,
						"Cannot connect to the requested IP and port.\n"
								+ "Check whether they are still available.\n"
								+ "The system replied with: "
								+ ex.getLocalizedMessage(), "Cannot Connect",
						JOptionPane.ERROR_MESSAGE);
				UsefulMethods.log.log(Level.ERROR,
						"Cannot connect to request IP and port.", ex);
			}
		}
		requestToggle(false);
